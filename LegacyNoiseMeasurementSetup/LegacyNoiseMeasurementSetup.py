...
from nodes import ExperimentSettings, Node
...
class MainView(mainViewBase,mainViewForm):
    ...
    def setModel(self, model):
       ...
       #self._dataMapper.setOrientation(QtCore.Qt.Horizontal)
       
       #print(self._dataMapper.rootIndex().parent)
...
if __name__== "__main__":
    ...
    QtCore.QObject.connect(vm, QtCore.SIGNAL("dataChanged(QModelIndex, QModelIndex)"), update)
